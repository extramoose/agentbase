-- Fix: add 'essays' to rpc_update_entity allowed tables
-- rpc_update_entity was missing 'essays' from v_allowed_tables, causing
-- "Table essays is not allowed for generic updates" errors.
