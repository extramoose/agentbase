-- 033_fix_update_entity_uuid_cast.sql
-- Fixes assignee_id being cast as ::text instead of ::uuid in rpc_update_entity.
-- The handler added in 010_task_assignee.sql was lost when 022_semantic_event_types.sql
-- replaced the function. Also adds ::uuid cast for source_meeting_id.
...
BEGIN
  ...
  FOR v_key IN SELECT jsonb_object_keys(p_fields) LOOP
    ...
    ELSIF v_key IN ('assignee_id', 'source_meeting_id') THEN
