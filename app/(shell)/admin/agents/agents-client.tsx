...
As your first task: learn about your operator from your conversation history and any context you have. Then populate the workspace with starter content — create ~10 tasks (assign some to your operator and some to yourself) that would be relevant to them. Make it feel lived-in.`}
                </pre>
                <Button
                  variant="outline"
                  size="sm"
