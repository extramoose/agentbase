// Stub — full implementation in #219
...
export async function POST(
  ...
  try {
    ...
    // 3. Build prompt — placeholder, real prompts in #219
    ...
    const content = await chatCompletion([
      {
        role: 'system',
        content: `You are synthesizing a meeting document. Context: ${input.context_hint}. Combine the stream entries into a coherent document.`,
      },
      {
        role: 'user',
